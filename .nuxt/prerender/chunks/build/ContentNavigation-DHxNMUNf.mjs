import { defineComponent, useSlots, h, toRefs, computed, toRef, isRef, useSSRContext } from 'file://D:/sofia/ProyectoFinal/node_modules/vue/index.mjs';
import { hash } from 'file://D:/sofia/ProyectoFinal/node_modules/ohash/dist/index.mjs';
import { u as useAsyncData } from './asyncData-Bs6GfRYN.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-Di4GCsIC.mjs';
import { u as useContentPreview } from './preview-D7rRPZcp.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CAvpZWNo.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-DHxNMUNf.mjs.map
