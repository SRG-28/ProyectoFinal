...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-8 container mx-auto relative" }, _attrs))} data-v-a8d2a8ca>`);
      if (unref(airline).imagen) {
        _push(`<div class="absolute inset-0 -z-10 overflow-hidden" data-v-a8d2a8ca><img${ssrRenderAttr("src", unref(airline).imagen)} alt="Fondo aerol\xEDnea" class="w-full h-full object-cover opacity-30 blur-sm" data-v-a8d2a8ca><div class="absolute inset-0 bg-white/60" data-v-a8d2a8ca></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<h1 class="text-4xl font-extrabold text-center mb-8 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent animate-text relative z-10" data-v-a8d2a8ca> \u{1F6EB} ${ssrInterpolate(unref(airline).nombre)}</h1><div class="flex flex-col md:flex-row items-start gap-10 bg-white bg-opacity-90 rounded-3xl shadow-xl p-6 relative z-10" data-v-a8d2a8ca><div class="flex-shrink-0" data-v-a8d2a8ca>`);
      if (unref(airline).imagen) {
        _push(`<img${ssrRenderAttr("src", unref(airline).imagen)}${ssrRenderAttr("alt", unref(airline).nombre)} class="w-56 h-auto rounded-2xl shadow-lg border border-gray-200" data-v-a8d2a8ca>`);
      } else {
        _push(`<div class="w-56 h-72 flex items-center justify-center bg-gray-100 rounded-2xl shadow border border-gray-200" data-v-a8d2a8ca><span class="text-gray-400 italic" data-v-a8d2a8ca>Sin logo</span></div>`);
      }
      _push(`</div><div class="flex-1 text-left space-y-4" data-v-a8d2a8ca><p class="text-lg text-gray-700" data-v-a8d2a8ca><strong data-v-a8d2a8ca>Fundaci\xF3n:</strong> ${ssrInterpolate(unref(airline).fundacion)}</p><p class="text-lg text-gray-700" data-v-a8d2a8ca><strong data-v-a8d2a8ca>Pa\xEDs:</strong> ${ssrInterpolate(unref(airline).pais)}</p><p class="text-lg text-gray-700 leading-relaxed" data-v-a8d2a8ca><strong data-v-a8d2a8ca>Descripci\xF3n:</strong> ${ssrInterpolate(unref(airline).descripcion)}</p><p class="text-lg text-purple-700 font-semibold" data-v-a8d2a8ca><a${ssrRenderAttr("href", unref(airline).web)} target="_blank" class="hover:underline" data-v-a8d2a8ca>Sitio web oficial</a></p></div></div><div class="mt-12 relative z-10" data-v-a8d2a8ca><h2 class="text-2xl font-bold mb-6 flex items-center gap-2" data-v-a8d2a8ca> \u2708\uFE0F Aviones operados por ${ssrInterpolate(unref(airline).nombre)}</h2>`);
      if (unref(airplanesByAirline).length > 0) {
        _push(`<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6" data-v-a8d2a8ca><!--[-->`);
        ssrRenderList(unref(airplanesByAirline), (airplane) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="w-24 h-24 mb-2" data-v-a8d2a8ca${_scopeId}>`);
                if (airplane.imagen) {
                  _push2(`<img${ssrRenderAttr("src", airplane.imagen)}${ssrRenderAttr("alt", airplane.modelo)} class="w-full h-full object-contain rounded-xl" data-v-a8d2a8ca${_scopeId}>`);
                } else {
                  _push2(`<div class="w-full h-full flex items-center justify-center bg-gray-100 rounded-xl" data-v-a8d2a8ca${_scopeId}><span class="text-gray-400 italic text-sm" data-v-a8d2a8ca${_scopeId}>Sin imagen</span></div>`);
                }
                _push2(`</div><p class="text-sm font-semibold text-gray-700 text-center" data-v-a8d2a8ca${_scopeId}>${ssrInterpolate(airplane.modelo)}</p>`);
              } else {
                return [
        ...
        _push(`<p class="text-gray-500 italic mt-2" data-v-a8d2a8ca> No hay aviones registrados para esta aerol\xEDnea. </p>`);
      }
      _push(`</div><div class="text-center mt-12 relative z-10" data-v-a8d2a8ca>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
...
const _airlinedetail_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a8d2a8ca"]]);

export { _airlinedetail_ as default };
//# sourceMappingURL=_airlinedetail_-BOgtIpCo.mjs.map
