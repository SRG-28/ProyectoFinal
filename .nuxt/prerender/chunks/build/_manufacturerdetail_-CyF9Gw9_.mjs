...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-8 container mx-auto relative" }, _attrs))} data-v-803d5236>`);
      if (unref(manufacturer).imagen) {
        _push(`<div class="absolute inset-0 -z-10 overflow-hidden" data-v-803d5236><img${ssrRenderAttr("src", unref(manufacturer).imagen)} alt="Fondo fabricante" class="w-full h-full object-cover opacity-30 blur-sm" data-v-803d5236><div class="absolute inset-0 bg-white/60" data-v-803d5236></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<h1 class="text-4xl font-extrabold text-center mb-8 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent animate-text relative z-10" data-v-803d5236> \u{1F3ED} ${ssrInterpolate(unref(manufacturer).nombre)}</h1><div class="flex flex-col md:flex-row items-start gap-10 bg-white bg-opacity-90 rounded-3xl shadow-xl p-6 relative z-10" data-v-803d5236><div class="flex-shrink-0" data-v-803d5236>`);
      if (unref(manufacturer).imagen) {
        _push(`<img${ssrRenderAttr("src", unref(manufacturer).imagen)}${ssrRenderAttr("alt", unref(manufacturer).nombre)} class="w-56 h-auto rounded-2xl shadow-lg border border-gray-200" data-v-803d5236>`);
      } else {
        _push(`<div class="w-56 h-72 flex items-center justify-center bg-gray-100 rounded-2xl shadow border border-gray-200" data-v-803d5236><span class="text-gray-400 italic" data-v-803d5236>Sin logo</span></div>`);
      }
      _push(`</div><div class="flex-1 text-left space-y-4" data-v-803d5236><p class="text-lg text-gray-700" data-v-803d5236><strong data-v-803d5236>Fundaci\xF3n:</strong> ${ssrInterpolate(unref(manufacturer).fundacion)}</p><p class="text-lg text-gray-700" data-v-803d5236><strong data-v-803d5236>Pa\xEDs:</strong> ${ssrInterpolate(unref(manufacturer).pais_sede)}</p><p class="text-lg text-gray-700 leading-relaxed" data-v-803d5236><strong data-v-803d5236>Historia:</strong> ${ssrInterpolate(unref(manufacturer).descripcion)}</p><p class="text-lg text-purple-700 font-semibold" data-v-803d5236><a${ssrRenderAttr("href", unref(manufacturer).web)} target="_blank" class="hover:underline" data-v-803d5236>Sitio web oficial</a></p></div></div><div class="mt-10 relative z-10" data-v-803d5236><h2 class="text-2xl font-bold mb-6 flex items-center gap-2" data-v-803d5236> \u2708\uFE0F Aviones fabricados por ${ssrInterpolate(unref(manufacturer).nombre)}</h2>`);
      if (unref(airplanesByManufacturer).length > 0) {
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-803d5236><!--[-->`);
        ssrRenderList(unref(airplanesByManufacturer), (airplane) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="w-20 h-20 flex-shrink-0" data-v-803d5236${_scopeId}>`);
                if (airplane.imagen) {
                  _push2(`<img${ssrRenderAttr("src", airplane.imagen)}${ssrRenderAttr("alt", airplane.modelo)} class="w-full h-full object-cover rounded-lg shadow" data-v-803d5236${_scopeId}>`);
                } else {
                  _push2(`<div class="w-full h-full flex items-center justify-center bg-gray-100 rounded-lg" data-v-803d5236${_scopeId}><span class="text-gray-400 text-xs italic" data-v-803d5236${_scopeId}>Sin imagen</span></div>`);
                }
                _push2(`</div><span class="flex-1 text-left" data-v-803d5236${_scopeId}>${ssrInterpolate(airplane.modelo)}</span>`);
              } else {
                return [
        ...
        _push(`<p class="text-gray-500 italic mt-2" data-v-803d5236> No hay aviones registrados para este fabricante. </p>`);
      }
      _push(`</div><div class="text-center mt-10 relative z-10" data-v-803d5236>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
...
const _manufacturerdetail_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-803d5236"]]);

export { _manufacturerdetail_ as default };
//# sourceMappingURL=_manufacturerdetail_-CyF9Gw9_.mjs.map
