...
import { withAsyncContext, mergeProps, unref, withCtx, createTextVNode, createVNode, createBlock, openBlock, toDisplayString, useSSRContext } from 'file://D:/sofia/ProyectoFinal/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderList } from 'file://D:/sofia/ProyectoFinal/node_modules/vue/server-renderer/index.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(airplane).imagen) {
        _push(`<div class="absolute inset-0 w-full h-full overflow-hidden -z-10" data-v-467184f8><img${ssrRenderAttr("src", unref(airplane).imagen)} alt="Fondo avi\xF3n" class="w-full h-full object-cover opacity-30 blur-sm" data-v-467184f8><div class="absolute inset-0 bg-white/60" data-v-467184f8></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</div></div><div class="mt-12 relative z-10" data-v-467184f8><h2 class="text-2xl font-bold mb-6 text-gray-800" data-v-467184f8>\u{1F6EB} Aerol\xEDneas que operan este avi\xF3n</h2>`);
      if (unref(airlines).length > 0) {
        ...
        _push(`<p class="text-gray-500 italic mt-2" data-v-467184f8>No hay aerol\xEDneas registradas para este avi\xF3n.</p>`);
      }
...
//# sourceMappingURL=_airplanedetail_-DL-HwMhD.mjs.map
