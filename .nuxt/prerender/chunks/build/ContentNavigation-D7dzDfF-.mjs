import { defineComponent, useSlots, h, toRefs, computed, toRef, isRef, useSSRContext } from 'file://D:/sofia/Proyecto8SofiaRafael/node_modules/vue/index.mjs';
import { hash } from 'file://D:/sofia/Proyecto8SofiaRafael/node_modules/ohash/dist/index.mjs';
import { u as useAsyncData } from './asyncData-BJZsHZcW.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-ClBvIUu6.mjs';
import { u as useContentPreview } from './preview-DgybUhg6.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BO1GCuUh.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-D7dzDfF-.mjs.map
