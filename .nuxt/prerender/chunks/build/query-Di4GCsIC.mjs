import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from 'file://D:/sofia/ProyectoFinal/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CAvpZWNo.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-Di4GCsIC.mjs.map
