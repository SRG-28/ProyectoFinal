  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(airplane).imagen) {
        _push(`<div class="absolute inset-0 w-full h-full overflow-hidden -z-10" data-v-e19bd509><img${ssrRenderAttr("src", unref(airplane).imagen)} alt="Fondo avión" class="w-full h-full object-cover opacity-30 blur-sm" data-v-e19bd509><div class="absolute inset-0 bg-white/60" data-v-e19bd509></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</div></div><div class="mt-12 relative z-10" data-v-e19bd509><h2 class="text-2xl font-bold mb-6 text-gray-800" data-v-e19bd509>🛫 Aerolíneas que operan este avión</h2>`);
      if (unref(airlines).length > 0) {
        ...
        _push(`<p class="text-gray-500 italic mt-2" data-v-e19bd509>No hay aerolíneas registradas para este avión.</p>`);
      }
...
//# sourceMappingURL=_airplanedetail_-BVrWUXO1.js.map
